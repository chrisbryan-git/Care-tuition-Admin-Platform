...
<body>
    ...
    <section id="navigation">
        ...
        <h3 id="header" style="font-family: 'monotype corssiva', cursive;">Teachers At Cares </h3>
        ...
        <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <img src="images\noun-expense-5864569.png" alt="img">
                    <a href="#" class="btn btn-primary" id="showInactive">Click here</a>
                </div>
            </div>
            ...
            <div class="card" id="teacher-card">
                <div class="card-body">
                    ...
                    <img src="images\noun-expense-5864569.png" alt="img">
                    <a href="Teacher_form.php" class="btn btn-primary">Click here</a>
                </div>
            </div>
        </div>
        </div>
            ...
            <div class="table-container">
                <div class="table-wrapper">
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            if ($result->num_rows > 0) {
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    echo '<td>';                                    
                                    echo '<i class="fas fa-chalkboard-teacher" style="font-size: 15px; margin:15px; color: green;"></i>';                                    
                                    echo '</td>';

                                    echo "<td style=\"position: sticky; left: 0; z-index: 0; background-color: #f7f7f7; color:blue;\">" . $row['teacherName'] . "</td>";
                        ...
                        echo '<a class="edit-btn" href="edit_teacher?id=' . $row['id'] . '">Edit</a>';
                        echo '<a class="delete-btn" href="delete_teacher?id=' . $row['id'] . '">Delete</a>';
                        echo '</td>';
                                    echo "</tr>";
                                }
                            } else {
