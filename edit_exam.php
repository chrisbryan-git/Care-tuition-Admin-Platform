...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($conn->query($updateSql) === TRUE) {
        ...
        if ($conn->query($updateAverageSql) === TRUE) {
            echo "<script>alert('Successfully updated!');window.location.href='exams'; </script>";
            exit;
            // header("Location: exam"); // Redirect back to the main page
            exit();
        } else {
        ...
        <form method="post">
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <input readonly type="text" id="studentName" name="studentName" class="form-control" value="<?php echo isset($row['student_name']) ? $row['student_name'] : ''; ?>">
                </div>
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    <label for="exam_type" class="form-label">Year of Study</label>
                    <input type="text" name="yearOfStudy" class="form-control" value="<?php echo isset($row['year_of_study']) ? $row['year_of_study'] : ''; ?>">
                </div>
            </div>
            <div class="row">
                <div class="col-md-4">
                    <label for="exam_date" class="form-label">Exam Date</label>
                    <input type="date" name="exam_date" class="form-control" value="<?php echo isset($row['date']) ? $row['date'] : ''; ?>">
                </div>
